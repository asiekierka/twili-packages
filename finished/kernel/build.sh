...
VER=3.3.2
LOGONAME=cutie_mark
#we use our own mirror as kernel.org lags
#test -e linux-$VER.tar.bz2 || wget -c http://www.kernel.org/pub/linux/kernel/v3.0/linux-$VER.tar.bz2
test -e linux-$VER.tar.bz2 || wget -c http://twi.asiekierka.pl/mirrors/linux-$VER.tar.bz2
...
make CC=gcc ARCH=i386 HOSTCFLAGS=-D_GNU_SOURCE CFLAGS="" LDFLAGS="" -j5
